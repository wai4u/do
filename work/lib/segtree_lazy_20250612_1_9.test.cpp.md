...
data:
  ...
  bundledCode: "#line 1 \"work/lib/segtree_lazy_20250612_1_9.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_I\"\n#line\
    ...
    \t\tX vl=e(),vr=e();\n\t\twhile(l<r){\n\t\t\tif(l&1)vl=op(vl,d[l++]);\n\t\t\t\
    if(r&1)vr=op(d[--r],vr);\n\t\t\tl>>=1,r>>=1;\n\t\t}\n\t\treturn op(vl,vr);\n\t\
    }\n};\n#line 4 \"work/lib/segtree_lazy_20250612_1_9.test.cpp\"\nstruct X{long\
    ...
    cin>>n>>q;\n\tsegtree_lazy<X,op,e,int,mapping,composition,id>seg(n+1,[&](int i){return\
    \ X{0,1};});\n\twhile(q--){\n\t\tint t,l,r;\n\t\tcin>>t>>l>>r;\n\t\tif(t==0){\n\
  ...
  verifiedWith: []
documentation_of: work/lib/segtree_lazy_20250612_1_9.test.cpp
layout: document
redirect_from:
- /verify/work/lib/segtree_lazy_20250612_1_9.test.cpp
- /verify/work/lib/segtree_lazy_20250612_1_9.test.cpp.html
