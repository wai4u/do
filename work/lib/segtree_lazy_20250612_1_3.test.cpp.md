...
data:
  ...
  bundledCode: "#line 1 \"work/lib/segtree_lazy_20250612_1_3.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\"\n#line\
    ...
    \t\tX vl=e(),vr=e();\n\t\twhile(l<r){\n\t\t\tif(l&1)vl=op(vl,d[l++]);\n\t\t\t\
    if(r&1)vr=op(d[--r],vr);\n\t\t\tl>>=1,r>>=1;\n\t\t}\n\t\treturn op(vl,vr);\n\t\
    }\n};\n#line 4 \"work/lib/segtree_lazy_20250612_1_3.test.cpp\"\nint op(int x,int\
    \ y){return x==-1?y:x;}\nint e(){return -1;}\nint main(){\n\tint n,q;\n\tcin>>n>>q;\n\
  ...
  verifiedWith: []
documentation_of: work/lib/segtree_lazy_20250612_1_3.test.cpp
layout: document
redirect_from:
- /verify/work/lib/segtree_lazy_20250612_1_3.test.cpp
- /verify/work/lib/segtree_lazy_20250612_1_3.test.cpp.html
