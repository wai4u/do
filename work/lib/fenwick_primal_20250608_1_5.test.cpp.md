...
data:
  ...
  bundledCode: "#line 1 \"work/lib/fenwick_primal_20250608_1_5.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n#line 1 \"\
    ...
    \t\treturn y;\n\t}\n\tT sum(int l,int r){\n\t\tassert(0<=l&&l<=r&&r<=n);\n\t\t\
    return sum(r)-sum(l);\n\t}\n};\n#line 4 \"work/lib/fenwick_primal_20250608_1_5.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_primal_20250608_1_5.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_primal_20250608_1_5.test.cpp
- /verify/work/lib/fenwick_primal_20250608_1_5.test.cpp.html
