...
data:
  ...
  bundledCode: "#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"\
    ...
    \ cout io::_o\n#line 2 \"work/lib/fenwick_primal_20250608_1_1.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n#line 1 \"\
    ...
    \tT sum(int l,int r){\n\t\tassert(0<=l&&l<=r&&r<=n);\n\t\treturn sum(r)-sum(l);\n\
    \t}\n};\n#line 4 \"work/lib/fenwick_primal_20250608_1_1.test.cpp\"\nint main(){\n\
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_primal_20250608_1_1.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_primal_20250608_1_1.test.cpp
- /verify/work/lib/fenwick_primal_20250608_1_1.test.cpp.html
