...
data:
  ...
  bundledCode: "#line 1 \"work/lib/isqrt_20250615_12.hpp\"\n//newton's method\n//O(loglogN)\n\
    //iterative\n//https://en.wikipedia.org/wiki/Integer_square_root#Algorithm_using_Newton's_method\n\
    //https://atcoder.jp/contests/abc400/submissions/66801253\ntemplate<class T>\n\
    T isqrt(T n){\n\tassert(n>=0);\n\tif(n<2)return n;\n\tT r=n>>1,l=r+n/r>>1;\n\t\
  ...
  verifiedWith: []
documentation_of: work/lib/isqrt_20250615_12.hpp
layout: document
redirect_from:
- /library/work/lib/isqrt_20250615_12.hpp
- /library/work/lib/isqrt_20250615_12.hpp.html
