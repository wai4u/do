...
data:
  ...
  bundledCode: "#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"\
    ...
    \ cout io::_o\n#line 2 \"work/lib/fenwick_20250608_6.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n#line 1 \"work/lib/fenwick_20250608_6.hpp\"\
    ...
    }\n};\n#line 4 \"work/lib/fenwick_20250608_6.test.cpp\"\nint main(){\n\tint n,q;\n\
    \tcin>>n>>q;\n\tfenwick<long>s(n);\n\tfor(int i=0;i<n;i++){\n\t\tint x;\n\t\t\
    cin>>x;\n\t\ts.add(i,x);\n\t}\n\twhile(q--){\n\t\tint t,i,j;\n\t\tcin>>t>>i>>j;\n\
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_20250608_6.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_20250608_6.test.cpp
- /verify/work/lib/fenwick_20250608_6.test.cpp.html
