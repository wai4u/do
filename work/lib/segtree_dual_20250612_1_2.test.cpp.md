...
data:
  ...
  bundledCode: "#line 1 \"work/lib/segtree_dual_20250612_1_2.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\"\n#line\
    ...
    \ apply(l,x);\n\t\tl+=w,r+=w;\n\t\tif(hung){\n\t\t\tpull(l/(l&-l));\n\t\t\tpull(r/(r&-r)-1);\n\
    \t\t}\n\t\thung=1;\n\t\twhile(l<r){\n\t\t\tif(l&1)_apply(l++,x);\n\t\t\tif(r&1)_apply(--r,x);\n\
    \t\t\tl>>=1,r>>=1;\n\t\t}\n\t}\n};\n#line 4 \"work/lib/segtree_dual_20250612_1_2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: work/lib/segtree_dual_20250612_1_2.test.cpp
layout: document
redirect_from:
- /verify/work/lib/segtree_dual_20250612_1_2.test.cpp
- /verify/work/lib/segtree_dual_20250612_1_2.test.cpp.html
