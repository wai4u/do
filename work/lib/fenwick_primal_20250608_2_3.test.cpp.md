...
data:
  ...
  bundledCode: "#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"\
    ...
    \ cout io::_o\n#line 2 \"work/lib/fenwick_primal_20250608_2_3.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_B\"\
    ...
    \ r){\n\t\tassert(0<=l&&l<=r&&r<=n);\n\t\treturn sum(r)-sum(l);\n\t}\n};\n#line\
    \ 4 \"work/lib/fenwick_primal_20250608_2_3.test.cpp\"\nint main(){\n\tint n,q;\n\
    \tcin>>n>>q;\n\tfenwick<int>s(n);\n\twhile(q--){\n\t\tint t,i,j;\n\t\tcin>>t>>i>>j;\n\
    \t\ti--;\n\t\tif(t==0)s.add(i,j);\n\t\telse cout<<s.sum(i,j)<<'\\n';\n\t}\n}\n"
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_primal_20250608_2_3.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_primal_20250608_2_3.test.cpp
- /verify/work/lib/fenwick_primal_20250608_2_3.test.cpp.html
