...
data:
  ...
  bundledCode: "#line 1 \"work/lib/fenwick_primal_20250608_1_2.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n#line 1 \"\
    ...
    \ cout io::_o\n#line 1 \"work/lib/fenwick_primal_20250608_1.hpp\"\n//primal\n\
    ...
    \t\treturn y;\n\t}\n\tT sum(int l,int r){\n\t\tassert(0<=l&&l<=r&&r<=n);\n\t\t\
    return sum(r)-sum(l);\n\t}\n};\n#line 4 \"work/lib/fenwick_primal_20250608_1_2.test.cpp\"\
    \nint main(){\n\tint n,q;\n\tcin>>n>>q;\n\tfenwick<long>s(n);\n\tfor(int i=0;i<n;i++){\n\
    \t\tint x;\n\t\tcin>>x;\n\t\ts.set(i,x);\n\t}\n\twhile(q--){\n\t\tint t,i,j;\n\
    \t\tcin>>t>>i>>j;\n\t\tif(t==0)s.add(i,j);\n\t\telse cout<<s.sum(i,j)<<'\\n';\n\
    \t}\n}\n"
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_primal_20250608_1_2.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_primal_20250608_1_2.test.cpp
- /verify/work/lib/fenwick_primal_20250608_1_2.test.cpp.html
