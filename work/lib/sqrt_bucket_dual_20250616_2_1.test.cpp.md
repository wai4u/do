...
data:
  ...
  bundledCode: "#line 1 \"work/lib/sqrt_bucket_dual_20250616_2_1.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\"\
    \n#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"Ofast,unroll-loops\"\
    ...
    \ cout io::_o\n#line 1 \"work/lib/sqrt_bucket_dual_20250616_2.hpp\"\n//non commutative\
    \ monoid\n//https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\n\
    ...
    \ i=max(k*m,l);i<r;i++)a[i]=op(a[i],x);\n\t}\n};\n#line 4 \"work/lib/sqrt_bucket_dual_20250616_2_1.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\"\
    \n#include\"io_20250608_1.hpp\"\n#include\"sqrt_bucket_dual_20250616_2.hpp\"\n\
    int op(int x,int y){return y==-1?x:y;}\nint e(){return -1;}\nint main(){\n\tint\
    \ n,q;\n\tcin>>n>>q;\n\tsqrt_bucket_dual<int,op,e>seg(n+1);\n\tfor(int i=0;i<=n;i++)seg[i]=(1l<<31)-1;\n\
    \twhile(q--){\n\t\tint t;\n\t\tcin>>t;\n\t\tif(t==0){\n\t\t\tint l,r,x;\n\t\t\t\
    cin>>l>>r>>x;\n\t\t\tseg.apply(l,r+1,x);\n\t\t}else{\n\t\t\tint i;\n\t\t\tcin>>i;\n\
  ...
  - work/lib/sqrt_bucket_dual_20250616_2.hpp
  ...
  verifiedWith: []
documentation_of: work/lib/sqrt_bucket_dual_20250616_2_1.test.cpp
layout: document
redirect_from:
- /verify/work/lib/sqrt_bucket_dual_20250616_2_1.test.cpp
- /verify/work/lib/sqrt_bucket_dual_20250616_2_1.test.cpp.html
