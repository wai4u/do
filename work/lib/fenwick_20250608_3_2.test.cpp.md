...
data:
  ...
  bundledCode: "#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"\
    ...
    \ cout io::_o\n#line 2 \"work/lib/fenwick_20250608_3_2.test.cpp\"\n#define PROBLEM\
    ...
    assert(l<=r);\n\t\treturn l==r?T{}:sum(r)-sum(l);\n\t}\n};\n#line 4 \"work/lib/fenwick_20250608_3_2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_20250608_3_2.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_20250608_3_2.test.cpp
- /verify/work/lib/fenwick_20250608_3_2.test.cpp.html
