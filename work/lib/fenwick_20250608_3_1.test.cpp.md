...
data:
  ...
  bundledCode: "#line 1 \"work/lib/optimize_20250608_1.hpp\"\n#pragma GCC optimize(\"\
    ...
    \ cout io::_o\n#line 2 \"work/lib/fenwick_20250608_3_1.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n#line 1 \"work/lib/fenwick_20250608_3.hpp\"\
    ...
    assert(l<=r);\n\t\treturn l==r?T{}:sum(r)-sum(l);\n\t}\n};\n#line 4 \"work/lib/fenwick_20250608_3_1.test.cpp\"\
    \nint main(){\n\tint n,q;\n\tcin>>n>>q;\n\tlong cum=0;\n\tfenwick<long,1>s(n,[&](int\
    \ i){\n\t\tint x;\n\t\tcin>>x;\n\t\tcum+=x;\n\t\treturn cum;\n\t});\n\twhile(q--){\n\
  ...
  - work/lib/fenwick_20250608_3.hpp
  ...
  verifiedWith: []
documentation_of: work/lib/fenwick_20250608_3_1.test.cpp
layout: document
redirect_from:
- /verify/work/lib/fenwick_20250608_3_1.test.cpp
- /verify/work/lib/fenwick_20250608_3_1.test.cpp.html
