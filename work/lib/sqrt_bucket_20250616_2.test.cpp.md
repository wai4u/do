...
data:
  ...
  bundledCode: "#line 1 \"work/lib/sqrt_bucket_20250616_2.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_A\"\n#line\
    ...
    \ cout io::_o\n#line 1 \"work/lib/sqrt_bucket_20250616_2.hpp\"\n//minimum\n//commutative\
    \ monoid\u306E\u7279\u6B8A\u30B1\u30FC\u30B9\n//https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_A\n\
    ...
    #line 4 \"work/lib/sqrt_bucket_20250616_2.test.cpp\"\nint main(){\n\tint n,q;\n\
    \tcin>>n>>q;\n\tsqrt_bucket<int,(1l<<31)-1>seg(n);\n\twhile(q--){\n\t\tint t,i,j;\n\
    \t\tcin>>t>>i>>j;\n\t\tif(t==0){\n\t\t\tseg.set(i,j);\n\t\t}else{\n\t\t\tcout<<seg.prod(i,j+1)<<'\\\
    n';\n\t\t}\n\t}\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_A\"\
    \n#include\"io_20250608_1.hpp\"\n#include\"sqrt_bucket_20250616_2.hpp\"\nint main(){\n\
    \tint n,q;\n\tcin>>n>>q;\n\tsqrt_bucket<int,(1l<<31)-1>seg(n);\n\twhile(q--){\n\
    \t\tint t,i,j;\n\t\tcin>>t>>i>>j;\n\t\tif(t==0){\n\t\t\tseg.set(i,j);\n\t\t}else{\n\
    \t\t\tcout<<seg.prod(i,j+1)<<'\\n';\n\t\t}\n\t}\n}\n"
  dependsOn:
  ...
  - work/lib/sqrt_bucket_20250616_2.hpp
  ...
  verifiedWith: []
documentation_of: work/lib/sqrt_bucket_20250616_2.test.cpp
layout: document
redirect_from:
- /verify/work/lib/sqrt_bucket_20250616_2.test.cpp
- /verify/work/lib/sqrt_bucket_20250616_2.test.cpp.html
