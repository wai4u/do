...
data:
  ...
  bundledCode: "#line 1 \"work/lib/segtree_lazy_20250612_1_8.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_H\"\n#line\
    ...
    \t\tX vl=e(),vr=e();\n\t\twhile(l<r){\n\t\t\tif(l&1)vl=op(vl,d[l++]);\n\t\t\t\
    if(r&1)vr=op(d[--r],vr);\n\t\t\tl>>=1,r>>=1;\n\t\t}\n\t\treturn op(vl,vr);\n\t\
    }\n};\n#line 4 \"work/lib/segtree_lazy_20250612_1_8.test.cpp\"\nint op(int x,int\
    \ y){return min(x,y);}\nint e(){return 1e9;}\nint mapping(int f,int x){return\
    \ f+x;}\nint composition(int f,int g){return f+g;}\nint id(){return 0;}\nint main(){\n\
    \tint n,q;\n\tcin>>n>>q;\n\tsegtree_lazy<int,op,e,int,mapping,composition,id>seg(n+1,[&](int\
    \ i){return 0;});\n\twhile(q--){\n\t\tint t,l,r;\n\t\tcin>>t>>l>>r;\n\t\tif(t==0){\n\
    \t\t\tint x;\n\t\t\tcin>>x;\n\t\t\tseg.apply(l,r+1,x);\n\t\t}else{\n\t\t\tcout<<seg.prod(l,r+1)<<'\\\
    n';\n\t\t}\n\t}\n}\n"
  ...
  verifiedWith: []
documentation_of: work/lib/segtree_lazy_20250612_1_8.test.cpp
layout: document
redirect_from:
- /verify/work/lib/segtree_lazy_20250612_1_8.test.cpp
- /verify/work/lib/segtree_lazy_20250612_1_8.test.cpp.html
