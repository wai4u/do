...
data:
  ...
  bundledCode: "#line 1 \"work/lib/segtree_dual_20250612_1.hpp\"\n//https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\n\
    //https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_E\ntemplate<class\
    \ T,T(*op)(T,T),T(*e)()>\nstruct segtree_dual{\n\tint n=0,w=0;\n\tvector<T>d;\n\
  ...
  code: "//https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D\n//https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_E\n\
    ...
    vector<T>d;\n\tbool hung=0;\n\tsegtree_dual(){}\n\tsegtree_dual(int n){init(n);}\n\
    \ttemplate<class F>\n\tsegtree_dual(int n,F f){init(n,f);}\n\ttemplate<class U>\n\
    \tsegtree_dual(const vector<U>&a){init(a);}\n\tvoid init(int n){\n\t\tthis->n=n;\n\
    \t\tw=1;while(w<n)w<<=1;\n\t\td.assign(w+w,e());\n\t\thung=0;\n\t}\n\ttemplate<class\
    \ F>\n\tvoid init(int n,F f){\n\t\tinit(n);\n\t\tfor(int i=0;i<n;i++)d[w+i]=f(i);\n\
    \t}\n\ttemplate<class U>\n\tvoid init(const vector<U>&a){\n\t\tinit(a.size(),[&](int\
    \ i){return a[i];});\n\t}\n\tvoid _apply(int i,T x){d[i]=op(d[i],x);}\n\tvoid\
  ...
  verifiedWith:
  - work/lib/segtree_dual_20250612_1_1.test.cpp
  - work/lib/segtree_dual_20250612_1_3.test.cpp
  - work/lib/segtree_dual_20250612_1_2.test.cpp
documentation_of: work/lib/segtree_dual_20250612_1.hpp
layout: document
redirect_from:
- /library/work/lib/segtree_dual_20250612_1.hpp
- /library/work/lib/segtree_dual_20250612_1.hpp.html
